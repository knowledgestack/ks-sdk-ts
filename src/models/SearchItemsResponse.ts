...
/**
 * A search page plus how many items of each type the query matched.
 * 
 * ``counts_by_type`` ignores any ``part_type`` filter so the filter chips can
 * keep showing every type's count while one of them is selected.
 * @export
...
export interface SearchItemsResponse {
    ...
    offset: number;
    /**
     * Matches per item type, keyed by SearchablePartType and unaffected by the part_type filter
     * @type {{ [key: string]: number; }}
     * @memberof SearchItemsResponse
     */
    countsByType?: { [key: string]: number; };
}
export const SearchItemsResponsePropertyValidationAttributesMap: {
    [property: string]: {
        maxLength?: number,
        minLength?: number,
        pattern?: string,
...
/**
 * Check if a given object implements the SearchItemsResponse interface.
 */
export function instanceOfSearchItemsResponse(value: object): value is SearchItemsResponse {
...
export function SearchItemsResponseFromJSON(json: any): SearchItemsResponse {
    return SearchItemsResponseFromJSONTyped(json, false);
}

export function SearchItemsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): SearchItemsResponse {
    if (json == null) {
        return json;
    }
    return {
        ...
        'limit': json['limit'],
        'offset': json['offset'],
        'countsByType': json['counts_by_type'] == null ? undefined : json['counts_by_type'],
    };
}

export function SearchItemsResponseToJSON(json: any): SearchItemsResponse {
    return SearchItemsResponseToJSONTyped(json, false);
}

export function SearchItemsResponseToJSONTyped(value?: SearchItemsResponse | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'limit': value['limit'],
        'offset': value['offset'],
        'counts_by_type': value['countsByType'],
    };
}
